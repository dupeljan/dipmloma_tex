...
\caption{illustration of projecting the translational velocity vector in the direction of movement of the $ i $ - th wheel}
...
\caption{illustration of designing a velocity vector on a local coordinate system}
...
\caption{cart model on four roller wheels}
...
\caption{illustration of the rotational movement of the trolley on four roller-bearing wheels}
...
\caption{projection of the rotational velocity vector on the local coordinate system}
